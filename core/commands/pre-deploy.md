...
5. **Dependencies** — no known CVEs in production dependencies (profile audit command)
...
Read `.forge.yaml` → get active profiles → use profile commands for audits and tests.
