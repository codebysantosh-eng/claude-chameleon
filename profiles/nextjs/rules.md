...
COMMANDS: test=npx vitest run | lint=next lint | format=npx prettier --check . | typecheck=npx tsc --noEmit | build=next build | audit=npm audit --production | e2e=npx playwright test
